...
function rawDataM = SesCreateM(sesnum)
    rawSigFdir="C:\Martian\학습\공모전\KEMDy19\ECG\ECG_NAdelete\Sess"+sesnum+"M_seg.csv"
    ...
    Emotion_Ffile = readtable("C:\Martian\학습\공모전\KEMDy19\annotation\Session"+sesnum+"_M_res.csv", VariableNamingRule='preserve');
    Emotion_Ffile(1,:)=[];
 ...
 rawSignalM=ECG_signal;
 rawValueM=EmotionF;
 rawIDM=SegID;

 rawDataM= table(rawIDM, rawSignalM, rawValueM);
